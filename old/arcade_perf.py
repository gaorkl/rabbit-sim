...
class SPGView(arcade.Window):
    ...
    def __init__(self, w, h, scale):
        ...
        self.scale = scale
        self.dick_sprites = arcade.SpriteList(use_spatial_hash=True)
        self.dicks = []
    ...
    def on_update(self):
        ...
        for d in self.dicks:
            if d.movable:
                arcade.check_for_collision_with_list(d.sprite, self.dick_sprites)
...
for _ in range(400):
    ...
    dick = dk.SPGDick(Vec2d(x, y), angle, movable=movable)
